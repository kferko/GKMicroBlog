...
# add several reviews
Review.create(user_id: 1, dish_id: 1, title: "The Szechuan king of Philly!", description: "Seriously one of my favorite things to eat in the city. Caution: can be surprisingly spicy!", rating: 5)
Review.create(user_id: 2, dish_id: 1, title: "Come prepared for spicyness", description: "Very good usually, but it can be inconsistent in spicyness. A solid choice at Han Dynasty.", rating: 4)
Review.create(user_id: 3, dish_id: 1, title: "Overrated Chinese food", description: "Tastes like mushy peanut butter. Gross. Next please!", rating: 1)
Review.create(user_id: 4, dish_id: 1, title: "The BEST noodle spot", description: "Omg - looooove the dan dan!", rating: 5)
Review.create(user_id: 1, dish_id: 2, title: "The Szechuan king of Philly!", description: "Probably my favorite entree on the menu. Spicy, light, fresh, and accessible to Szechuan newbies.", rating: 5)
Review.create(user_id: 3, dish_id: 2, title: "Overrated Chinese food", description: "Acceptable until I ate a pepper and nearly choked. Should come with a warning label.", rating: 2)
Review.create(user_id: 1, dish_id: 3, title: "Overhyped tourist trap", description: "I seriously don't understand the hype about this cheesesteak. It's OK. Not worth waiting in line for, though.", rating: 3)
Review.create(user_id: 3, dish_id: 3, title: "Stay away!", description: "Wouldn't feed this to my worst enemy. Hot garbage.", rating: 1)
Review.create(user_id: 4, dish_id: 3, title: "A Philadelphia institution. Not bad!", description: "Not bad, but there are better cheesesteaks in the city.", rating: 3)
Review.create(user_id: 1, dish_id: 4, title: "Overhyped tourist trap", description: "This was actually a really tasty sandwich, probably better than the famous original cheesesteak.", rating: 3)
Review.create(user_id: 2, dish_id: 4, title: "You gotta try Pat's at least once.", description: "Pretty good stuff, but I'd strongly recommend getting provolone. Stay away from the whiz on this one!", rating: 3)
Review.create(user_id: 1, dish_id: 5, title: "Perfect Valentine's Night", description: "I still dream about this dish. You will never think of gnocchi in the same way after experiencing it in the rich brown butter. Get a reservation right now!", rating: 4)
Review.create(user_id: 2, dish_id: 6, title: "Best italian in the city", description: "An outstanding dish. The almonds and truffle were perfectly balanced and just left me wanting more.", rating: 5)
Review.create(user_id: 3, dish_id: 7, title: "Vegetarian paradise", description: "This was easily the best seitan I've ever had. The texture was sublime. Who needs meat when you have Vedge?", rating: 5)
Review.create(user_id: 4, dish_id: 8, title: "Brilliant take on veggies", description: "You might think that ordering a carrot as an entree is bizarre (well, I did), but have no fear. This dish was so playful, creative, exciting, and suprisingly satisfying that I can't wait to order it again! ", rating: 4)
